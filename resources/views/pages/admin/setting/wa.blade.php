                ...
                <div class="modal-body">
                    <form action="javascript:void(0)" id="MainForm" name="MainForm" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <ul>
                                <li>Nama anggota = __nama_anggota__</li>
                                <li>Email anggota = __email_anggota__</li>
                                <li>Garis Baru = \n</li>
                                <li>Teks Tebal = *teks*</li>
                                <li>Teks Miring = _teks_</li>
                                <li>Teks Coret = ~teks~</li>
                            </ul>
                            <textarea type="text" class="form-control" id="template" name="template" placeholder="Template" rows="6"></textarea>
                        </div>
                    </form>
                </div>
