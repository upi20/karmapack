    ...
    public function run()
    {
        ...
        \DB::table('whatsapp_brodcast')->insert(array(
            ...
            array(
                'id' => '1',
                'nama' => 'Kurasi tahap 2',
                'template' => 'Hallo Kak *__nama_peserta__* , Salam Cempor! 
...
Dispora Kota Bandung. Saat ini, tim kami masih dalam proses kurasi Tahap 2.',
                'created_at' => '2023-08-14 17:45:43',
                'updated_at' => '2023-08-14 17:45:43',
            ),
            1 =>
            array(
                'id' => '2',
                'nama' => 'Konfirmasi kehadiran',
                'template' => '"Halo Kak *__nama_peserta__*,\\n
Salam Cempor!\\n
\\n
...
\\n
*Bagi calon peserta yang masih bersedia untuk melanjutkan Pelatihan ini, dimohon untuk konfirmasi batas waktu pukul 15.00 WIB, 19 September 2023) :\\n
\\n
\\n
...
\\n
Cempor, Wani diadu!"""\\n',
                'created_at' => '2023-08-14 18:13:12',
                'updated_at' => '2023-09-19 10:01:36',
            ),
            2 =>
            array(
                'id' => '3',
                'nama' => 'Konfirmasi Pendaftar',
                'template' => 'Hallo Kak  *__nama_peserta__* , Kakak telah berhasil mendaftar Akun Cempor. Silahkan untuk update biodata di Akun cempor dan melanjutkan ke pemilihan pelatihan ya ....',
                'created_at' => '2023-08-14 19:13:55',
                'updated_at' => '2023-08-14 19:13:55',
            ),
            3 =>
            array(
                'id' => '4',
                'nama' => 'Invite Grup',
                'template' => 'Hai Kak *__nama_peserta__*,
Salam Cempor !!
...
Cempor, Wani Diadu!',
                'created_at' => '2023-08-16 13:04:30',
                'updated_at' => '2023-08-16 13:07:05',
            ),
            4 =>
            array(
                'id' => '5',
                'nama' => 'Kelengkapan Akun Cempor',
                'template' => 'Hallo Kak *__nama_peserta__* , Selamat ya kakak telah lolos di pelatihan Wood Craft. Untuk mempermudah pendataan silahkan login/masuk akun kakak di www.cempordigital.com menggunakan email : __email_peserta__ dengan password 12345678 . Silahkan rubah password dan lengkapi data yang masih kosong. Mengisi biodata hingga selesai penting untuk Absensi kehadiran, sertifikat dan fasilitas lainya . jika ada kendala bisa hubungi kami kembali. terima kasih :)',
                'created_at' => '2023-08-16 13:59:06',
                'updated_at' => '2023-08-16 14:02:39',
            ),
            5 =>
            array(
                'id' => '6',
...
Bagi calon peserta yang masih bersedia untuk melanjutkan Proses Kurasi tahap akhir, dimohon untuk mengisi formulir kesediaan pada tautan berikut (batas waktu pukul 10.00 WIB, 16 Agustus 2023) :
...
Cempor, Wani diadu!',
                'created_at' => '2023-09-05 09:19:17',
                'updated_at' => '2023-09-05 09:31:11',
            ),
            6 =>
            array(
                'id' => '7',
...
Bagi calon peserta yang masih bersedia untuk melanjutkan dimohon konfirmasinya untuk mengikuti *Meeting Online* pada:
...
Cempor, Wani diadu!',
                'created_at' => '2023-09-14 22:11:33',
                'updated_at' => '2023-09-14 22:11:33',
            ),
        ));
    }
}
